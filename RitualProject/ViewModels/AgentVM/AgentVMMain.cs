...
{
    public class AgentVMMain : ViewModel, ICloseWindow
    {
        private UserControl _AgentOrdersUserControl;
        ...
        public AgentVMMain()
        {
            _AgentOrdersUserControl = new AgentDocumentUserControl();
            ...
            currentControl = _AgentOrdersUserControl;
        }
